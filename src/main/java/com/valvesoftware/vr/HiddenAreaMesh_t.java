...
public class HiddenAreaMesh_t extends Structure {
	public com.valvesoftware.vr.HmdVector2_t.ByReference pVertexData;
	...
	public HiddenAreaMesh_t(com.valvesoftware.vr.HmdVector2_t.ByReference pVertexData, int unTriangleCount) {
		super();
